  ...
  return (
    <div className="min-h-screen bg-slate-950 text-sky-50 pb-20 overflow-x-hidden">
      ...
      <section className="py-12 relative flex overflow-x-hidden">
        ...
        <div className="flex animate-marquee gap-3 sm:gap-6 whitespace-nowrap">
          {[...scrollingImages, ...scrollingImages].map((imgUrl, index) => (
            <div
              key={index}
              className="relative w-40 h-28 sm:w-72 sm:h-48 md:w-96 md:h-64 rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl shadow-sky-900/20 border border-sky-800/30 flex-shrink-0"
            >
              <img
                src={imgUrl}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8">

          {/* Feature 1 */}
          <div className="bg-sky-900/20 border border-sky-800/40 rounded-2xl sm:rounded-3xl p-5 sm:p-8 backdrop-blur-sm hover:bg-sky-900/30 transition-colors">
            <div className="w-10 h-10 sm:w-14 sm:h-14 bg-sky-600/20 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 border border-sky-500/30">
              <svg className="w-6 h-6 sm:w-8 sm:h-8 text-sky-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
            </div>
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Seamless Search</h3>
          ...
          {/* Feature 2 */}
          <div className="bg-sky-900/20 border border-sky-800/40 rounded-2xl sm:rounded-3xl p-5 sm:p-8 backdrop-blur-sm hover:bg-sky-900/30 transition-colors">
            <div className="w-10 h-10 sm:w-14 sm:h-14 bg-indigo-600/20 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 border border-indigo-500/30">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Secure Access</h3>
            <p className="text-sm sm:text-base text-sky-200/80 leading-relaxed">
          ...
          {/* Feature 3 */}
          <div className="bg-sky-900/20 border border-sky-800/40 rounded-2xl sm:rounded-3xl p-5 sm:p-8 backdrop-blur-sm hover:bg-sky-900/30 transition-colors">
            <div className="w-10 h-10 sm:w-14 sm:h-14 bg-blue-600/20 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 border border-blue-500/30">
              <svg className="w-6 h-6 sm:w-8 sm:h-8 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
              </svg>
            </div>
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Marketplace</h3>
            <p className="text-sm sm:text-base text-sky-200/80 leading-relaxed">
